...
# check if page already exists
	...
	if pl_page.exists():
# make edit only if not redirection and magulbot is creator of page
		if (not pl_page.isRedirectPage()) and pl_page.getVersionHistory()[-1][2] == u'MagulBot':
